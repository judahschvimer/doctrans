...
def edit_translation():
    ...
    try:
        ...
        return json.dumps({ "code": e.code , "msg": e.msg , "file_path": e.file_path, "username": e.username, "target_language": e.target_language}), e.code
...
def lock_error(username, language, file):
    return render_template("423.html", username=username, language=language, file=file)
...
class Pagination(object):
    '''This class creates pages for the views so that it doesn't need to show all files or sentences at once'''
    ...
    def iter_pages(self, left_edge=2, left_current=2, right_current=5, right_edge=2):
        ...
        :Parameters:
            - 'left_edge': how many numbers are shown on the left edge of the page list
            - 'left_current': how many numbers are shown left of the current page
            - 'right_current': how many numbers are shown right of the current page
            - 'right_edge': how many numbers are shown on the right edge of the page list
        :Returns:
            - iterator over the page numbers
        '''
        last = 0
